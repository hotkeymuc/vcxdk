...
// As of 2022-05-24 cr16b_asm.py should correctly put ROM entries at base_offset 0x100000 (.double) with no need to manually alter the base address
#define CARTRIDGE_ROM_POINTER(p) p
